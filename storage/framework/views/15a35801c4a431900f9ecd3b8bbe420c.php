...
<?php $__env->startSection('content'); ?>
    <section class="section">
        <form action="<?php echo e(route('custom-fields.store')); ?>" method="POST" class="create-form" data-success-function="afterCustomFieldCreation" data-parsley-validate enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="row">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\eClassify\resources\views/custom-fields/create.blade.php ENDPATH**/ ?>